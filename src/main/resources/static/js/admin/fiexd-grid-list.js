...
jQuery(document).ready(function() {
  ...
  // http://localhost:8080/system/sample/grid/fiexdGridList.xml
  // 화면 그리기
  // PD_Grid.makeScreen("./fiexdGridList.xml", fixed);

  // PD_Grid.makeScreen("./fiexdGridList.xml", fixed);
  // PD_Grid.makeScreen("./fiexd-grid-list-layout.json", fixed);
  PD_Grid.makeScreen("/js/admin/fiexd-grid-list-layout.json", fixed);
