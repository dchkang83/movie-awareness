...
jQuery(document).ready(function() {
  ...
  PD_Grid.makeScreen("/js/admin/target-list-layout.json", fixed);
...
//      else {
//        var params = {};
//        //var targetSrl = PD_GridUtils.getListCellValue(listId, rowIndex, 'targetSrl');
