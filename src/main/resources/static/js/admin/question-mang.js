...
function fnTabClick_QuestionMang(arrParams) {
  ...
  switch (type) {
    case "list":
      PD_Common.fnOpenContent("/admin/question/question-list", "tab_contents_edge_left", params);
      break;
    case "form1":
    case "form2":
      if(params) {
      ...
      PD_Common.fnOpenContent("/admin/question/question-" + type, "tab_contents_edge_right", params);
      break;
    default:
      break;
  }
