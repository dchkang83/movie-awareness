...
public class SurveyListRequestVO extends RequestListSearchVO {
  ...
  protected Map<String, String> getTableColumnMap() {
    ...
    tableColumnMap.put("surveySrl",     "sv.survey_srl");
    tableColumnMap.put("surveyName",    "sv.survey_name");
    tableColumnMap.put("surveyStatus",  "sv.survey_status");
