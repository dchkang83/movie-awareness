...
public class QuestionTemplateListRequestVO extends RequestListSearchVO {
  ...
  protected Map<String, String> getTableColumnMap() {
    ...
    tableColumnMap.put("questionSrl",   "qtt.question_srl");
    tableColumnMap.put("questionName",  "qtt.question_name");
